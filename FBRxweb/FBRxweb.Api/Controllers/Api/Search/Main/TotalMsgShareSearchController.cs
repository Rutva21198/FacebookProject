...
namespace FBRxweb.Api.Controllers.PostModule
{
    ...
    public class SearchTotalMsgShareController : ControllerBase
    {
        private IDbContextManager<MainSqlDbContext> DbContextManager { get; set; }
        public SearchTotalMsgShareController(IDbContextManager<MainSqlDbContext> dbContextManager) {
        ...
        public async Task<IActionResult> Post([FromBody]Dictionary<string,string> searchParams)
        {
            ...
            var result = await DbContextManager.StoreProc<StoreProcResult>("[dbo].spTotalMessageShareOnPost", spParameters);
