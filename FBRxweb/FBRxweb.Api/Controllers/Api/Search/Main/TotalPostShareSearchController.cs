...
namespace FBRxweb.Api.Controllers.PostModule
{
    ...
    public class SearchTotalPostShareController : ControllerBase
    {
        private IDbContextManager<MainSqlDbContext> DbContextManager { get; set; }
        public SearchTotalPostShareController(IDbContextManager<MainSqlDbContext> dbContextManager) {
        ...
        public async Task<IActionResult> Post([FromBody]Dictionary<string,string> searchParams)
        {
            ...
            var result = await DbContextManager.StoreProc<StoreProcResult>("[dbo].spTotalShareOnPost", spParameters);
