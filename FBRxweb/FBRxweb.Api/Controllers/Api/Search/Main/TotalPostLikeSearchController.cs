...
namespace FBRxweb.Api.Controllers.PostModule
{
    ...
    public class SearchTotalPostLikeController : ControllerBase
    {
        private IDbContextManager<MainSqlDbContext> DbContextManager { get; set; }
        public SearchTotalPostLikeController(IDbContextManager<MainSqlDbContext> dbContextManager) {
        ...
        public async Task<IActionResult> Post([FromBody]Dictionary<string,string> searchParams)
        {
            ...
            var result = await DbContextManager.StoreProc<StoreProcResult>("[dbo].spTotalLikeOnPost", spParameters);
