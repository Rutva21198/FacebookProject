...
namespace FBRxweb.Api.Controllers.PostModule
{
    ...
    public class SearchTotalMsgCommentController : ControllerBase
    {
        private IDbContextManager<MainSqlDbContext> DbContextManager { get; set; }
        public SearchTotalMsgCommentController(IDbContextManager<MainSqlDbContext> dbContextManager) {
        ...
        public async Task<IActionResult> Post([FromBody]Dictionary<string,string> searchParams)
        {
            ...
            var result = await DbContextManager.StoreProc<StoreProcResult>("[dbo].spTotalMessageCommentOnPost", spParameters);
